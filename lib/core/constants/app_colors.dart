...
class LightColors implements AppThemeColors {
  ...
  @override
  Color get surface => Colors.white.withValues(alpha: 0.95); // Almost white with slight opacity
  @override
  ...
  @override
  Color get inputBackground => Colors.white.withValues(alpha: 0.95); // Slightly translucent
  @override
