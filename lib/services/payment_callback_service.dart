...
/// Paystack C2B return handling via deep link only: truepay://payment/callback?reference=fund_…
///
...
class PaymentCallbackService {
  ...
  Future<void> _onDeepLink(Uri uri) async {
    ...
    if (uri.host != 'payment' || uri.path != '/callback') return;
  ...
  /// Idempotent confirm/poll for a Paystack funding reference (fund_…).
